...
<div class="integration-header">
	...
	<?php else : ?>
		<span class="sui-description" style="margin-top: 20px;"><?php esc_html_e( 'Setup Google Client to be used by Forminator to communicate with the Google Sheets server.', Forminator::DOMAIN ); ?></span>
